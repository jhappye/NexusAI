...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Compound scroll container built on Base UI ScrollArea. These stories focus on panel-style compositions that already exist throughout NexusAI: dense sidebars, sticky list headers, multi-pane workbenches, horizontal rails, and overlay surfaces. Scrollbar placement should be adjusted by consumer spacing classes such as margin-based overrides instead of right/bottom positioning utilities.',
      },
    },
  },
  tags: ['autodocs'],
...
export const VerticalPanels: Story = {
  render: () => (
    <StoryCard
      ...
      description="Two common NexusAI surfaces: a straightforward content panel using the shipped scrollbar skin, and a denser queue pane that adds sticky structure, a viewport mask, and a slightly inset scrollbar."
    >
