...
describe('ChunkCardList Integration', () => {
  ...
  describe('Complete Workflows', () => {
    ...
    it('should render complete QA chunking workflow', () => {
        ...
        qa_chunks: [
          {
            ...
            answer: 'NexusAI is an open-source LLM application development platform.',
          },
          {
      ...
      expect(screen.getByText('What is NexusAI?')).toBeInTheDocument()
      expect(screen.getByText('NexusAI is an open-source LLM application development platform.')).toBeInTheDocument()
