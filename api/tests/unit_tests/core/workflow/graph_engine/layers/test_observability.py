...
class TestObservabilityLayerInitialization:
    ...
    @patch("core.app.workflow.layers.observability.nexusai_config.ENABLE_OTEL", True)
    ...
    @patch("core.app.workflow.layers.observability.nexusai_config.ENABLE_OTEL", False)
