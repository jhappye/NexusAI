...
class TestOAuthDiscovery:
    ...
    def test_check_support_resource_discovery_success(self, mock_get):
        ...
        mock_get.assert_called_once_with(
            ...
            headers={"MCP-Protocol-Version": LATEST_PROTOCOL_VERSION, "User-Agent": "NexusAI"},
        )
...
class TestAuthorizationFlow:
    ...
    def test_register_client_no_endpoint(self):
        ...
        client_metadata = OAuthClientMetadata(client_name="NexusAI", redirect_uris=["https://redirect.example.com"])
...
class TestAuthOrchestration:
    ...
    def test_register_client(self, mock_post):
        ...
        client_metadata = OAuthClientMetadata(client_name="NexusAI", redirect_uris=["https://re"])
