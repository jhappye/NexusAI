...
class MilvusVectorFactory(AbstractVectorFactory):
    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> MilvusVector:
        ...
        return MilvusVector(
            ...
            config=MilvusConfig(
                uri=nexusai_config.MILVUS_URI or "",
                token=nexusai_config.MILVUS_TOKEN or "",
                user=nexusai_config.MILVUS_USER or "",
                password=nexusai_config.MILVUS_PASSWORD or "",
                database=nexusai_config.MILVUS_DATABASE or "",
                enable_hybrid_search=nexusai_config.MILVUS_ENABLE_HYBRID_SEARCH or False,
                analyzer_params=nexusai_config.MILVUS_ANALYZER_PARAMS or "",
            ),
        )
