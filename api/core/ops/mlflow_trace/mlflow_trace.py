...
class MLflowDataTrace(BaseTraceInstance):
    ...
    def workflow_trace(self, trace_info: WorkflowTraceInfo):
        ...
        # fields with sys.xyz is added by NexusAI, they are duplicate to trace_info.metadata
    ...
    def _parse_llm_inputs_and_attributes(self, node: WorkflowNodeExecutionModel) -> tuple[Any, dict]:
        ...
        if hasattr(SpanAttributeKey, "MESSAGE_FORMAT"):
            attributes[SpanAttributeKey.MESSAGE_FORMAT] = "nexusai"
    ...
    def message_trace(self, trace_info: MessageTraceInfo):
        ...
        if hasattr(SpanAttributeKey, "MESSAGE_FORMAT"):
            span.set_attribute(SpanAttributeKey.MESSAGE_FORMAT, "nexusai")
    ...
    def _get_node_span_type(self, node_type: str) -> str:
        """Map NexusAI node types to MLflow span types"""
        node_type_mapping = {
    ...
    def _resolve_tool_call_ids(self, messages: list[dict]):
        """
        The tool call message from NexusAI does not contain tool call ids, which is not
        ...
        for msg in messages:
            ...
            if msg["role"] == "tool":
                ...
                # assuming NexusAI runs tools sequentially
                if tool_call_ids:
